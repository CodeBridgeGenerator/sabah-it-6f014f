...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-primary">Maintenancereport</label><p className="m-0 ml-3" >{_entity?.maintenancereport}</p></div>
