...
const InventoryPage = (props) => {
    ...
    const service = _.find(config.services, { serviceName : "inventory"});
        ...
        <div className="mt-5">
            <div className="grid">
                ...
                <div className="col-6 flex justify-content-end">
                    <>
                    <Button label="add" loading={loading} icon="pi pi-plus" onClick={() => setShowCreateDialog(true)} role="inventory-add-button"/>
...
/>
            ...
            <InventoryCreateDialogComponent entity={newRecord} show={showCreateDialog} onHide={() => setShowCreateDialog(false)} onCreateResult={onCreateResult} />
